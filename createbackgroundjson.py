...
def create_baseFile(id,basedir,fileextention):
    if(os.path.exists('src/main/resources/assets/minecraft/blackburn/backgrounds.json')):
        ...
        while id < 26:
            ...
            'edition_width':addToFile(id,"edition_img_width"),'edition_hight':addToFile(id,"edition_img_hight"),'lang_posX':addToFile(id,"lang_posX"), 'lang_posY':addToFile(id,"lang_posY")}
