...
def create_baseFile(id,basedir,fileextention):
    ...
    while id < 26:
        ...
        'splash_posY':addToFile(id,"splash_posY"),'edition_posX':addToFile(id,"edition_posX"),'edition_posY':addToFile(id,"edition_posY"),'edition_posXNonFull':addToFile(id,"edition_posX_nonfull"),
