...
public class BuiltinRegistries
{
    ...
    public static <V, T extends V> T register(Registry<V> pRegistry, ResourceKey<V> pId, T pValue)
    {
        return ((WritableRegistry<V>)pRegistry).register(pId, pValue, Lifecycle.stable());
    }
