...
public class AquaticFeatures
{
    ...
    public static final ConfiguredFeature < SimpleRandomFeatureConfiguration, ? > WARM_OCEAN_VEGETATION = FeatureUtils.register("warm_ocean_vegetation", Feature.SIMPLE_RANDOM_SELECTOR.configured(new SimpleRandomFeatureConfiguration(List.of(() ->
    {
        return Feature.CORAL_TREE.configured(FeatureConfiguration.NONE).a();
    }, () ->
    {
        return Feature.CORAL_CLAW.configured(FeatureConfiguration.NONE).a();
    }, () ->
    {
        return Feature.CORAL_MUSHROOM.configured(FeatureConfiguration.NONE).a();
    }))));
}
