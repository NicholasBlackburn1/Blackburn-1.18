...
public class TreeFeatures
{
    ...
    public static final ConfiguredFeature <? , ? > HUGE_BROWN_MUSHROOM = FeatureUtils.register("huge_brown_mushroom", Feature.HUGE_BROWN_MUSHROOM.configured(new HugeMushroomFeatureConfiguration(BlockStateProvider.simple(Blocks.BROWN_MUSHROOM_BLOCK.defaultBlockState().setValue(HugeMushroomBlock.UP, Boolean.valueOf(true)).setValue(HugeMushroomBlock.DOWN, Boolean.valueOf(false))), BlockStateProvider.simple(Blocks.MUSHROOM_STEM.defaultBlockState().setValue(HugeMushroomBlock.UP, Boolean.valueOf(false)).setValue(HugeMushroomBlock.DOWN, Boolean.valueOf(false))), 3)));
    public static final ConfiguredFeature <? , ? > HUGE_RED_MUSHROOM = FeatureUtils.register("huge_red_mushroom", Feature.HUGE_RED_MUSHROOM.configured(new HugeMushroomFeatureConfiguration(BlockStateProvider.simple(Blocks.RED_MUSHROOM_BLOCK.defaultBlockState().setValue(HugeMushroomBlock.DOWN, Boolean.valueOf(false))), BlockStateProvider.simple(Blocks.MUSHROOM_STEM.defaultBlockState().setValue(HugeMushroomBlock.UP, Boolean.valueOf(false)).setValue(HugeMushroomBlock.DOWN, Boolean.valueOf(false))), 2)));
    ...
    public static final ConfiguredFeature < TreeConfiguration, ? > JUNGLE_TREE = FeatureUtils.register("jungle_tree", Feature.TREE.configured(createJungleTree().decorators(ImmutableList.of(new CocoaDecorator(0.2F), TrunkVineDecorator.INSTANCE, LeaveVineDecorator.INSTANCE)).ignoreVines().build()));
    ...
    public static final ConfiguredFeature <? , ? > JUNGLE_TREE_NO_VINE = FeatureUtils.register("jungle_tree_no_vine", Feature.TREE.configured(createJungleTree().ignoreVines().build()));
    ...
    public static final ConfiguredFeature < TreeConfiguration, ? > SUPER_BIRCH_BEES_0002 = FeatureUtils.register("super_birch_bees_0002", Feature.TREE.configured(createSuperBirch().decorators(ImmutableList.of(BEEHIVE_0002)).build()));
    public static final ConfiguredFeature < TreeConfiguration, ? > SUPER_BIRCH_BEES = FeatureUtils.register("super_birch_bees", Feature.TREE.configured(createSuperBirch().decorators(ImmutableList.of(BEEHIVE)).build()));
    public static final ConfiguredFeature < TreeConfiguration, ? > SWAMP_OAK = FeatureUtils.register("swamp_oak", Feature.TREE.configured(createStraightBlobTree(Blocks.OAK_LOG, Blocks.OAK_LEAVES, 5, 3, 0, 3).decorators(ImmutableList.of(LeaveVineDecorator.INSTANCE)).build()));
    ...
    public static final ConfiguredFeature < TreeConfiguration, ? > OAK_BEES_0002 = FeatureUtils.register("oak_bees_0002", Feature.TREE.configured(createOak().decorators(List.of(BEEHIVE_0002)).build()));
    public static final ConfiguredFeature < TreeConfiguration, ? > OAK_BEES_002 = FeatureUtils.register("oak_bees_002", Feature.TREE.configured(createOak().decorators(List.of(BEEHIVE_002)).build()));
    public static final ConfiguredFeature < TreeConfiguration, ? > OAK_BEES_005 = FeatureUtils.register("oak_bees_005", Feature.TREE.configured(createOak().decorators(List.of(BEEHIVE_005)).build()));
    public static final ConfiguredFeature < TreeConfiguration, ? > BIRCH_BEES_0002 = FeatureUtils.register("birch_bees_0002", Feature.TREE.configured(createBirch().decorators(List.of(BEEHIVE_0002)).build()));
    public static final ConfiguredFeature < TreeConfiguration, ? > BIRCH_BEES_002 = FeatureUtils.register("birch_bees_002", Feature.TREE.configured(createBirch().decorators(List.of(BEEHIVE_002)).build()));
    public static final ConfiguredFeature < TreeConfiguration, ? > BIRCH_BEES_005 = FeatureUtils.register("birch_bees_005", Feature.TREE.configured(createBirch().decorators(List.of(BEEHIVE_005)).build()));
    public static final ConfiguredFeature < TreeConfiguration, ? > FANCY_OAK_BEES_0002 = FeatureUtils.register("fancy_oak_bees_0002", Feature.TREE.configured(createFancyOak().decorators(List.of(BEEHIVE_0002)).build()));
    public static final ConfiguredFeature < TreeConfiguration, ? > FANCY_OAK_BEES_002 = FeatureUtils.register("fancy_oak_bees_002", Feature.TREE.configured(createFancyOak().decorators(List.of(BEEHIVE_002)).build()));
    public static final ConfiguredFeature < TreeConfiguration, ? > FANCY_OAK_BEES_005 = FeatureUtils.register("fancy_oak_bees_005", Feature.TREE.configured(createFancyOak().decorators(List.of(BEEHIVE_005)).build()));
    public static final ConfiguredFeature < TreeConfiguration, ? > FANCY_OAK_BEES = FeatureUtils.register("fancy_oak_bees", Feature.TREE.configured(createFancyOak().decorators(List.of(BEEHIVE)).build()));
