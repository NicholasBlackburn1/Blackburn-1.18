...
public class MappedRegistry<T> extends WritableRegistry<T>
{
    ...
    public T getRandom(Random pRandom)
    {
        ...
        return Util.a((T[])this.randomCache, pRandom);
    }

    public boolean containsKey(ResourceLocation pKey)
    {
        return this.storage.containsKey(pKey);
    }
    ...
    {
        return Codec.unboundedMap(ResourceLocation.CODEC.xmap(ResourceKey.elementKey(pRegistryKey), ResourceKey::location), pMapCodec).xmap((p_194547_) ->
        {
            MappedRegistry<T> mappedregistry = new MappedRegistry<>(pRegistryKey, pLifecycle);
