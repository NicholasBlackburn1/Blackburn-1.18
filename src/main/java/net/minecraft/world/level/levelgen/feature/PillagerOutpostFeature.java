...
{
    public static final WeightedRandomList<MobSpawnSettings.SpawnerData> OUTPOST_ENEMIES = WeightedRandomList.a(new MobSpawnSettings.SpawnerData(EntityType.PILLAGER, 1, 1, 1));
