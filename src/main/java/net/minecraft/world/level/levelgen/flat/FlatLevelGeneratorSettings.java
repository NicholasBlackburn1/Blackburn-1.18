    ...
    public Biome getBiomeFromSettings()
    {
        ...
        for (int j = 0; j < list1.size(); ++j)
        {
            ...
            if (!Heightmap.Types.MOTION_BLOCKING.isOpaque().test(blockstate))
            {
                ...
                biomegenerationsettings$builder.addFeature(GenerationStep.Decoration.TOP_LAYER_MODIFICATION, Feature.FILL_LAYER.configured(new LayerConfiguration(j, blockstate)).a());
            }
        }
