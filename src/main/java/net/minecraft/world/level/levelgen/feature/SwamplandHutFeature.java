...
{
    public static final WeightedRandomList<MobSpawnSettings.SpawnerData> SWAMPHUT_ENEMIES = WeightedRandomList.a(new MobSpawnSettings.SpawnerData(EntityType.WITCH, 1, 1, 1));
    public static final WeightedRandomList<MobSpawnSettings.SpawnerData> SWAMPHUT_ANIMALS = WeightedRandomList.a(new MobSpawnSettings.SpawnerData(EntityType.CAT, 1, 1, 1));
