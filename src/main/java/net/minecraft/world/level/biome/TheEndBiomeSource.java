...
public class TheEndBiomeSource extends BiomeSource
{
    ...
    private TheEndBiomeSource(Registry<Biome> pBiomes, long pSeed, Biome p_48633_, Biome pEnd, Biome pHighlands, Biome pMidlands, Biome pIslands)
    {
        super(ImmutableList.of(p_48633_, pEnd, pHighlands, pMidlands, pIslands));
        this.biomes = pBiomes;
        this.seed = pSeed;
        this.end = p_48633_;
        this.highlands = pEnd;
        this.midlands = pHighlands;
        this.islands = pMidlands;
        this.barrens = pIslands;
