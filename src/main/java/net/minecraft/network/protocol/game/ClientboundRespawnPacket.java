...
public class ClientboundRespawnPacket implements Packet<ClientGamePacketListener>
{
    ...
    public ClientboundRespawnPacket(DimensionType pDimensionType, ResourceKey<Level> pDimension, long pSeed, GameType p_132941_, @Nullable GameType pPlayerGameType, boolean pPreviousPlayerGameType, boolean pIsDebug, boolean pIsFlat)
    {
