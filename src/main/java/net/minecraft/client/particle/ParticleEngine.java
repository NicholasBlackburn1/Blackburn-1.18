                ...
                for (int l = 0; l < i; ++l)
                {
                    for (int i1 = 0; i1 < j; ++i1)
                    {
                        for (int j1 = 0; j1 < k; ++j1)
                        {
                            ...
                            {
                                TerrainParticle terrainparticle = new TerrainParticle(this.level, (double)pPos.getX() + d7, (double)pPos.getY() + d8, (double)pPos.getZ() + d9, d4 - 0.5D, d5 - 0.5D, d6 - 0.5D, pState, pPos);
                                Reflector.call(terrainparticle, Reflector.TerrainParticle_updateSprite, pState, pPos);
                                this.add(terrainparticle);
                            }
                            else
                            {
