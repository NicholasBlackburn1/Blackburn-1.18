...
public class TitleScreen extends Screen {
   ...
   public void render(PoseStack p_96739_, int p_96740_, int p_96741_, float p_96742_) {
      ...
      if ((l & -67108864) != 0) {
         ...
         overlay.renderEdition(this,splash, p_96739_,minecraft ,font, this.width,this.height, editionXFull.getAsInt(),editionYFull.getAsInt(),splashy.getAsInt(), j, l,editionXSmall.getAsInt(),editionYSmol.getAsInt(),editionImageWidth.getAsInt(),editionImageHight.getAsInt(),editionTextureWidth.getAsInt(),splashRot.getAsInt(),minecraft.getWindow().isFullscreen());
