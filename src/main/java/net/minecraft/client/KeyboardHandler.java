                ...
                Screen.wrapScreenError(() ->
                {
                    if (pScanCode != 1 && (pScanCode != 2 || !this.sendRepeatsToGui))
                    {
                        if (pScanCode == 0)
                        {
                            ...
                            {
                                aboolean[0] = Reflector.callBoolean(Reflector.ForgeHooksClient_onScreenKeyReleasedPre, this.minecraft.screen, p_90895_, pKey, pAction);
                            ...
                            {
                                aboolean[0] = Reflector.callBoolean(Reflector.ForgeHooksClient_onScreenKeyReleasedPost, this.minecraft.screen, p_90895_, pKey, pAction);
                            }
                        }
                    }
                    else {
                        ...
                        {
                            aboolean[0] = Reflector.callBoolean(Reflector.ForgeHooksClient_onScreenKeyPressedPre, this.minecraft.screen, p_90895_, pKey, pAction);
                        ...
                        {
                            aboolean[0] = Reflector.callBoolean(Reflector.ForgeHooksClient_onScreenKeyPressedPost, this.minecraft.screen, p_90895_, pKey, pAction);
                        }
                    }
        ...
        if (pWindowPointer == this.minecraft.getWindow().getWindow())
        {
            ...
            if (guieventlistener != null && this.minecraft.getOverlay() == null)
            {
                if (Character.charCount(p_90891_) == 1)
                {
                    Screen.wrapScreenError(() ->
                    {
                        if (!Reflector.ForgeHooksClient_onScreenCharTypedPre.exists() || !Reflector.callBoolean(Reflector.ForgeHooksClient_onScreenCharTypedPre, this.minecraft.screen, (char)p_90891_, pCodePoint))
                        {
                            ...
                            {
                                Reflector.callBoolean(Reflector.ForgeHooksClient_onScreenCharTypedPost, this.minecraft.screen, (char)p_90891_, pCodePoint);
                            }
                        }
                ...
                else
                {
                    for (char c0 : Character.toChars(p_90891_))
                    {
                        Screen.wrapScreenError(() ->
                        {
                            if (!Reflector.ForgeHooksClient_onScreenCharTypedPre.exists() || !Reflector.callBoolean(Reflector.ForgeHooksClient_onScreenCharTypedPre, this.minecraft.screen, c0, pCodePoint))
                            {
                                boolean flag = guieventlistener.charTyped(c0, pCodePoint);

                                if (Reflector.ForgeHooksClient_onScreenCharTypedPost.exists() && !flag)
                                {
                                    Reflector.callBoolean(Reflector.ForgeHooksClient_onScreenCharTypedPost, this.minecraft.screen, c0, pCodePoint);
                                }
                            }
                        }, "charTyped event handler", guieventlistener.getClass().getCanonicalName());
                    }
