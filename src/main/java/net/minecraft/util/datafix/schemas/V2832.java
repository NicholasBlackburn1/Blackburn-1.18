...
public class V2832 extends NamespacedSchema
{
    ...
    public void registerTypes(Schema p_185234_, Map<String, Supplier<TypeTemplate>> p_185235_, Map<String, Supplier<TypeTemplate>> p_185236_)
    {
        ...
        {
            return DSL.fields("Level", DSL.optionalFields("Entities", DSL.list(References.ENTITY_TREE.in(p_185234_)), "TileEntities", DSL.list(References.BLOCK_ENTITY.in(p_185234_)), "TileTicks", DSL.list(DSL.fields("i", References.BLOCK_NAME.in(p_185234_))), "Sections", DSL.list(DSL.optionalFields("biomes", DSL.optionalFields("palette", DSL.list(References.BIOME.in(p_185234_))), "block_states", DSL.optionalFields("palette", DSL.list(References.BLOCK_STATE.in(p_185234_))))), "Structures", DSL.optionalFields("Starts", DSL.compoundList(References.STRUCTURE_FEATURE.in(p_185234_)))));
        });
