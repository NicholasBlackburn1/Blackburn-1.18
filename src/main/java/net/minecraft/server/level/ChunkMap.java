...
public class ChunkMap extends ChunkStorage implements ChunkHolder.PlayerProvider
{
    ...
    {
        return this.getChunkRangeFuture(p_143118_, 2, (p_183856_0_) ->
        {
            return ChunkStatus.FULL;
        }).thenApplyAsync((p_183864_0_) ->
        {
            return p_183864_0_.mapLeft((p_183870_0_) -> {
                return (LevelChunk)p_183870_0_.get(p_183870_0_.size() / 2);
            });
    ...
    protected void saveAllChunks(boolean pFlush)
    {
        if (pFlush)
        {
            ...
            do
            {
                ...
                list.stream().map((p_183890_1_) ->
                {
                    CompletableFuture<ChunkAccess> completablefuture;

                    do {
                        completablefuture = p_183890_1_.getChunkToSave();
                        this.mainThreadExecutor.managedBlock(completablefuture::isDone);
                    }
                    while (completablefuture != p_183890_1_.getChunkToSave());

                    return completablefuture.join();
                }).filter((p_183866_0_) ->
                {
                    return p_183866_0_ instanceof ImposterProtoChunk || p_183866_0_ instanceof LevelChunk;
                }).filter(this::save).forEach((p_183818_1_) ->
                {
    ...
    private void scheduleUnload(long pChunkPos, ChunkHolder p_140183_)
    {
        ...
        completablefuture.thenAcceptAsync((p_198805_5_) ->
        {
            ...
            else if (this.pendingUnloads.remove(pChunkPos, p_140183_) && p_198805_5_ != null)
            {
                if (p_198805_5_ instanceof LevelChunk)
                {
                    ((LevelChunk)p_198805_5_).setLoaded(false);

                    if (Reflector.ChunkEvent_Unload_Constructor.exists())
                    {
                        Reflector.postForgeBusEvent(Reflector.ChunkEvent_Unload_Constructor, p_198805_5_);
                    }
                }

                this.save(p_198805_5_);

                if (this.entitiesInLevel.remove(pChunkPos) && p_198805_5_ instanceof LevelChunk)
                {
                    LevelChunk levelchunk = (LevelChunk)p_198805_5_;
                    this.level.unload(levelchunk);
                }

                this.lightEngine.updateChunkStatus(p_198805_5_.getPos());
                this.lightEngine.tryScheduleUpdate();
                this.progressListener.onStatusChange(p_198805_5_.getPos(), (ChunkStatus)null);
            }
        }, this.unloadQueue::add).whenComplete((p_198801_1_, p_198801_2_) ->
        {
            if (p_198801_2_ != null)
            {
                LOGGER.error("Failed to save chunk {}", p_140183_.getPos(), p_198801_2_);
            }
        });
    }
    ...
    public CompletableFuture<Either<ChunkAccess, ChunkHolder.ChunkLoadingFailure>> schedule(ChunkHolder p_140293_, ChunkStatus p_140294_)
    {
        ...
        else
        {
            ...
            {
                CompletableFuture<Either<ChunkAccess, ChunkHolder.ChunkLoadingFailure>> completablefuture = p_140294_.load(this.level, this.structureManager, this.lightEngine, (p_198868_2_) ->
                {
    ...
    private CompletableFuture<Either<ChunkAccess, ChunkHolder.ChunkLoadingFailure>> scheduleChunkGeneration(ChunkHolder pChunkHolder, ChunkStatus pChunkStatus)
    {
        ...
        CompletableFuture<Either<List<ChunkAccess>, ChunkHolder.ChunkLoadingFailure>> completablefuture = this.getChunkRangeFuture(chunkpos, pChunkStatus.getRange(), (p_198863_2_) ->
        {
            return this.getDependencyStatus(pChunkStatus, p_198863_2_);
        });
        this.level.getProfiler().incrementCounter(() ->
        {
            return "chunkGenerate " + pChunkStatus.getName();
        });
        Executor executor = (p_198883_2_) ->
        {
            this.worldgenMailbox.tell(ChunkTaskPriorityQueueSorter.message(pChunkHolder, p_198883_2_));
        };
        return completablefuture.thenComposeAsync((p_199349_5_) ->
        {
            return p_199349_5_.map((p_199355_5_) -> {
                try {
                    CompletableFuture<Either<ChunkAccess, ChunkHolder.ChunkLoadingFailure>> completablefuture1 = pChunkStatus.generate(executor, this.level, this.generator, this.structureManager, this.lightEngine, (p_198853_2_) -> {
                ...
                return CompletableFuture.completedFuture(Either.right(p_199346_2_));
            });
        }, executor);
    }
    ...
    private CompletableFuture<Either<ChunkAccess, ChunkHolder.ChunkLoadingFailure>> protoChunkToFullChunk(ChunkHolder p_140384_)
    {
        ...
        return completablefuture.thenApplyAsync((p_199332_2_) ->
        {
            ChunkStatus chunkstatus = ChunkHolder.getStatus(p_140384_.getTicketLevel());
            return !chunkstatus.isOrAfter(ChunkStatus.FULL) ? ChunkHolder.UNLOADED_CHUNK : p_199332_2_.mapLeft((p_199335_2_) -> {
                ChunkPos chunkpos = p_140384_.getPos();
                ProtoChunk protochunk = (ProtoChunk)p_199335_2_;
                ...
                if (protochunk instanceof ImposterProtoChunk)
                {
                    ...
                    levelchunk = new LevelChunk(this.level, protochunk, (p_199371_2_) -> {
        ...
        {
            this.mainThreadMailbox.tell(ChunkTaskPriorityQueueSorter.message(p_199398_2_, p_140384_.getPos().toLong(), p_140384_::getTicketLevel));
        });
    }
    ...
    public CompletableFuture<Either<LevelChunk, ChunkHolder.ChunkLoadingFailure>> prepareTickingChunk(ChunkHolder p_143054_)
    {
        ...
        CompletableFuture<Either<List<ChunkAccess>, ChunkHolder.ChunkLoadingFailure>> completablefuture = this.getChunkRangeFuture(chunkpos, 1, (p_199382_0_) ->
        {
            return ChunkStatus.FULL;
        });
        CompletableFuture<Either<LevelChunk, ChunkHolder.ChunkLoadingFailure>> completablefuture1 = completablefuture.thenApplyAsync((p_199387_1_) ->
        {
            return p_199387_1_.flatMap((p_199393_1_) -> {
                LevelChunk levelchunk = (LevelChunk)p_199393_1_.get(p_199393_1_.size() / 2);
        ...
        {
            this.mainThreadMailbox.tell(ChunkTaskPriorityQueueSorter.message(p_143054_, p_199395_2_));
        });
        completablefuture1.thenAcceptAsync((p_199361_2_) ->
        {
            p_199361_2_.ifLeft((p_199364_2_) -> {
                this.tickingGenerated.getAndIncrement();
                MutableObject<ClientboundLevelChunkWithLightPacket> mutableobject = new MutableObject<>();
                this.getPlayers(chunkpos, false).forEach((p_199376_3_) -> {
                    this.playerLoadedChunk(p_199376_3_, mutableobject, p_199364_2_);
                });
            });
        }, (p_199384_2_) ->
        {
            this.mainThreadMailbox.tell(ChunkTaskPriorityQueueSorter.message(p_143054_, p_199384_2_));
        });
        return completablefuture1;
    }
    ...
    {
        return this.getChunkRangeFuture(p_143110_.getPos(), 1, ChunkStatus::getStatusAroundFullChunk).thenApplyAsync((p_199367_0_) ->
        {
            return p_199367_0_.mapLeft((p_199374_0_) -> {
                return (LevelChunk)p_199374_0_.get(p_199374_0_.size() / 2);
            });
        }, (p_199338_2_) ->
        {
            this.mainThreadMailbox.tell(ChunkTaskPriorityQueueSorter.message(p_143110_, p_199338_2_));
        });
    }
    ...
    protected void setViewDistance(int pViewDistance)
    {
        ...
        if (i != this.viewDistance)
        {
            ...
            for (ChunkHolder chunkholder : this.updatingChunkMap.values())
            {
                ...
                MutableObject<ClientboundLevelChunkWithLightPacket> mutableobject = new MutableObject<>();
                this.getPlayers(chunkpos, false).forEach((p_199341_4_) ->
                {
                    SectionPos sectionpos = p_199341_4_.getLastSectionPos();
                    ...
                    this.updateChunkTracking(p_199341_4_, chunkpos, mutableobject, flag, flag1);
                });
            }
        }
    }
    ...
    void dumpChunks(Writer p_140275_) throws IOException
    {
        ...
        for (Entry<ChunkHolder> entry : this.visibleChunkMap.long2ObjectEntrySet())
        {
            ...
            Optional<LevelChunk> optional1 = optional.flatMap((p_199389_0_) ->
            {
                return p_199389_0_ instanceof LevelChunk ? Optional.of((LevelChunk)p_199389_0_) : Optional.empty();
            });
            csvoutput.a(chunkpos.x, chunkpos.z, chunkholder.getTicketLevel(), optional.isPresent(), optional.map(ChunkAccess::getStatus).orElse((ChunkStatus)null), optional1.map(LevelChunk::getFullStatus).orElse((ChunkHolder.FullChunkStatus)null), printFuture(chunkholder.getFullChunkFuture()), printFuture(chunkholder.getTickingChunkFuture()), printFuture(chunkholder.getEntityTickingChunkFuture()), this.distanceManager.getTicketDebugString(i), this.anyPlayerCloseEnoughForSpawning(chunkpos), optional1.map((p_183881_0_) ->
            {
                return p_183881_0_.getBlockEntities().size();
            }).orElse(0), tickingtracker.getTicketDebugString(i), tickingtracker.getLevel(i), optional1.map((p_183868_0_) ->
            {
                return p_183868_0_.getBlockTicks().count();
            }).orElse(0), optional1.map((p_199391_0_) ->
            {
                return p_199391_0_.getFluidTicks().count();
            }).orElse(0));
        }
    }
    ...
    private static String printFuture(CompletableFuture<Either<LevelChunk, ChunkHolder.ChunkLoadingFailure>> p_140279_)
    {
        try
        {
            ...
            return either != null ? either.map((p_199369_0_) ->
            {
                return "done";
            }, (p_199330_0_) ->
            {
