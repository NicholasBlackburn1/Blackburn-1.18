...
public class RealmsSelectFileToUploadScreen extends RealmsScreen
{
    ...
    class Entry extends ObjectSelectionList.Entry<RealmsSelectFileToUploadScreen.Entry>
    {
        ...
        {
            Component component = CommonComponents.a(new TextComponent(this.levelSummary.getLevelName()), new TextComponent(RealmsSelectFileToUploadScreen.formatLastPlayed(this.levelSummary)), RealmsSelectFileToUploadScreen.gameModeName(this.levelSummary));
