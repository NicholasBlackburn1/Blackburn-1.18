...
public class RealmsResetNormalWorldScreen extends RealmsScreen
{
    ...
    public void init()
    {
        ...
        this.addRenderableWidget(CycleButton.builder(LevelType::getName).a(LevelType.values()).withInitialValue(this.levelType).create(this.width / 2 - 102, row(4), 205, 20, new TranslatableComponent("selectWorld.mapType"), (p_167441_, p_167442_) ->
        {
