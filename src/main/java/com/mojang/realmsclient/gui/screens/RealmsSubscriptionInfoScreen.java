...
public class RealmsSubscriptionInfoScreen extends RealmsScreen
{
    ...
    private static final Component Z = new TranslatableComponent("mco.configure.world.subscription.unknown");
    private final Screen lastScreen;
    final RealmsServer serverData;
    final Screen mainScreen;
    private Component daysLeft = Z;
    private Component startDate = Z;
    @Nullable
