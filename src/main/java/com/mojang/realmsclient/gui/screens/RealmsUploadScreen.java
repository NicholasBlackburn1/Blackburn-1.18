...
public class RealmsUploadScreen extends RealmsScreen
{
    ...
    private void upload()
    {
        ...
        (new Thread(() ->
        {
                ...
                if (UPLOAD_LOCK.tryLock(1L, TimeUnit.SECONDS))
                {
                    ...
                    if (this.verify(file1))
                    {
                        ...
                        fileupload.upload((p_167557_) ->
                        {
                            ...
                            {
                                this.a(new TranslatableComponent("mco.upload.failed", p_167557_.errorMessage));
                            }
                            else {
                                this.a(new TranslatableComponent("mco.upload.failed", p_167557_.statusCode));
                            }
                        });
                    ...
                    if (Unit.humanReadable(k, unit).equals(Unit.humanReadable(5368709120L, unit1)) && unit != Unit.B)
                    {
                        ...
                        this.a(new TranslatableComponent("mco.upload.size.failure.line1", this.selectedLevel.getLevelName()), new TranslatableComponent("mco.upload.size.failure.line2", Unit.humanReadable(k, unit2), Unit.humanReadable(5368709120L, unit2)));
                        return;
                    }

                    this.a(new TranslatableComponent("mco.upload.size.failure.line1", this.selectedLevel.getLevelName()), new TranslatableComponent("mco.upload.size.failure.line2", Unit.humanReadable(k, unit), Unit.humanReadable(5368709120L, unit1)));
                    return;
                }
            ...
            {
                this.a(new TranslatableComponent("mco.upload.failed", ioexception.getMessage()));
                return;
            }
            catch (RealmsServiceException realmsserviceexception)
            {
                this.a(new TranslatableComponent("mco.upload.failed", realmsserviceexception.toString()));
                return;
            }
